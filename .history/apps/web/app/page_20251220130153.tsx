...
const ALL_RULES = [
  {
    id: '1',
    name: '61.8% Golden Retracement',
    description: 'Price retraces to golden ratio level',
    performance: '44% return, 52.6% win rate',
  },
  {
    id: '2',
    name: '78.6% Deep Discount',
    description: 'Deep pullback entry in strong trends',
    performance: '-33% return (disabled by default)',
  },
  {
    id: '3',
    name: '23.6% Shallow Pullback',
    description: 'Quick continuation in momentum',
    performance: '-6% return (disabled by default)',
  },
  {
    id: '4',
    name: 'Consolidation Breakout',
    description: 'Range breakout after sideways action',
    performance: '0% return (disabled by default)',
  },
  {
    id: '5',
    name: 'ATH Breakout Retest',
    description: 'Retest of all-time high as support',
    performance: '30% return, 38% win rate',
  },
  {
    id: '6',
    name: '50% Momentum',
    description: 'Equilibrium entry in strong momentum',
        ...
        {!hasRun && !error && (
          <div className='text-center py-16'>
            ...
            <p className='text-white/60 text-lg max-w-md mx-auto mb-8'>
              Select your preferred timeframe and trading rules above, then
              click the Run button to start the backtest.
            </p>
